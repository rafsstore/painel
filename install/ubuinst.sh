...
exit;
  ...
  echo -e 'by: @rafsapps' >/usr/lib/telegram
  msg -bar
...
wget https://raw.githubusercontent.com/rafsstore/painel/main/install/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://raw.githubusercontent.com/rafsstore/painel/main/install/verifatt.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/rafsstore/painel/main/install/verpweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/rafsstore/painel/main/install/verweb > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/rafsstore/painel/main/install/rafsssh.zip > /dev/null 2>&1
apt-get install unzip > /dev/null 2>&1
unzip rafsssh.zip > /dev/null 2>&1
...
rm rafsssh.zip index.html > /dev/null 2>&1
...
function inst_db { 
sleep 1
if [[ -e "/var/www/html/bdrafsssh.sql" ]]; then
    mysql -h localhost -u root -p"$pwdroot" --default_character_set utf8 sshplus < /var/www/html/bdrafsssh.sql > /dev/null 2>&1
    rm /var/www/html/bdrafsssh.sql > /dev/null 2>&1
else
    clear
...
echo ""
echo -e "WEB RAFS-SSH" | figlet
echo -e "                              \033[1;31mBy @rafsapps\033[1;36m"
echo ""
...
echo -e "PAINELWEB RAFS-SSH" | figlet
echo -e "                              \033[1;31mBy @rafsapps\033[1;36m"
echo ""
...
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@rafsapps\033[0m"
echo ""
